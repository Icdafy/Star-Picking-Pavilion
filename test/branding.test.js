...
test('package and installer metadata use the v0.0.7 canonical identity', () => {
...
test('release documentation points only to the canonical repository and installer', () => {
  ...
  assert.match(readme, /Star-Picking-Pavilion-Setup-0\.0\.7\.exe/);
  assert.match(releasing, /Star-Picking-Pavilion-Setup-0\.0\.7\.exe/);
